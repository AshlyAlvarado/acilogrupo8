package com.asilo.grupo8.2parcial.views.enfermos;
...
@PageTitle("Enfermos")
@Route(value = "enfermos-info/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@Uses(Icon.class)
public class EnfermosView extends Div implements BeforeEnterObserver {

    private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "enfermos-info/%s/edit";
    ...
    @Autowired
    public EnfermosView(SamplePersonService samplePersonService) {
        this.samplePersonService = samplePersonService;
        addClassNames("enfermos-view");
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(EnfermosView.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (samplePersonId.isPresent()) {
            ...
            if (samplePersonFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(EnfermosView.class);
            }
        }
    }
